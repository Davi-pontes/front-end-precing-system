...
<template>
    <main>
        <div class="flex w-full gap-2">
            <div class="bg-white w-[55vw] border rounded-md shadow-sm">
                    ...
                    <div class="flex w-full h-full gap-4">
                        ...
                        <div class="flex flex-col w-1/2">
                            ...
                            <input type="text" placeholder="Nome do produto" id="name"
                                class="border-2 outline-none rounded-md mb-4" v-model="datasProduct.nameProduct">
                            ...
                            <div class="flex w-[95%] h-full gap-4">
                                ...
                                <div class="flex flex-col w-1/2 mt-6">
                                    ...
                                    <input type="number" placeholder="0" id="stock"
                                        class="border-2 outline-none rounded-md mb-4 pl-2" v-model="datasProduct.tax"
                                ...
                                <div class="flex flex-col w-1/2 mt-6">
                                    ...
                                    <input type="number" placeholder="0" id="stock"
                                        class="border-2 outline-none rounded-md mb-4 pl-2" v-model="datasProduct.fixedCost"
                                        @change="updateAllNumbers">
